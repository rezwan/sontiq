...
namespace Santiq.Data
{
    public class MockUserServiceRepo : IUserServiceRepo
    {
        public List<UserService> GetPagedUserService(int pageNo)
        {
            ...
            userServices.Add(new UserService("Mobile attached controll 1", "SVC-MOB-DEF - 1", true, false, false, "PERSONAL", true, 10, 120, false));
            userServices.Add(new UserService("Mobile attached controll 2", "SVC-MOB-DEF - 2", true, false, false, "PERSONAL", true, 10, 120, false));
            userServices.Add(new UserService("Mobile attached controll 3", "SVC-MOB-DEF - 3", true, false, false, "PERSONAL", true, 10, 120, false));
            userServices.Add(new UserService("Mobile attached controll 4", "SVC-MOB-DEF - 4", true, false, false, "PERSONAL", true, 10, 120, false));
            userServices.Add(new UserService("Mobile attached controll 5", "SVC-MOB-DEF- 5", true, false, false, "PERSONAL", true, 10, 120, false));
            userServices.Add(new UserService("Mobile attached controll 6", "SVC-MOB-DEF - 6", true, false, false, "PERSONAL", true, 10, 120, false));
            userServices.Add(new UserService("Mobile attached controll 7", "SVC-MOB-DEF - 7", true, false, false, "PERSONAL", true, 10, 120, false));
